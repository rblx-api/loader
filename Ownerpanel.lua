SURE HUB: https://discord.gg/NtAz9rSTF
...
local function toggleBypass(state)
    ...
    if bypassFloatingButton then
        ...
        if btnFrame then
            ...
            if bypassToggled then
                btnFrame.BackgroundColor3 = Color3.fromRGB(192,192,192)
                if label then label.TextColor3 = Color3.fromRGB(0,0,0) end
            else
                btnFrame.BackgroundColor3 = Color3.fromRGB(0,0,0)
                if label then label.TextColor3 = Color3.fromRGB(192,192,192) end
            end
        end
    end
...
local function buildGui()
    ...
    sidebarImg.Image = "rbxassetid://124311138696338"
    ...
    brandLine.BackgroundColor3 = ACCENT
    ...
    contentSt.Color=ACCENT; contentSt.Thickness=1; contentSt.Transparency=0.18
    ...
    local function setActivePage(p)
        ...
        for _, t in ipairs(allTabs) do
            ...
            TS:Create(t.btn, TweenInfo.new(0.22), {
                BackgroundColor3 = isActive and Color3.fromRGB(185,185,185) or Color3.fromRGB(18,18,18),
    ...
    btnMain.BackgroundColor3 = Color3.fromRGB(185,185,185)
    ...
    local function animPill(pill, dot, on)
        TS:Create(pill,TweenInfo.new(0.18,Enum.EasingStyle.Quad),{BackgroundColor3=on and ACCENT or Color3.fromRGB(34,34,34)}):Play()
        ...
        if bypassFloatingButton then
            ...
            if btnFrame then
                ...
                if on then
                    ...
                    btnFrame.BackgroundColor3 = Color3.fromRGB(0,0,0)
                    if label then label.TextColor3 = ACCENT end
                end
            end
        end
    end)
