...
local T = {
    ...
    RAISED  = Color3.fromRGB(30,24,24),
    BORDER  = Color3.fromRGB(55,40,40),
    TEXT    = Color3.fromRGB(242,240,240),
    MUTED   = Color3.fromRGB(140,120,120),
    DIM     = Color3.fromRGB(75,55,55),
    ACCENT  = Color3.fromRGB(255,100,100),
    ON      = Color3.fromRGB(255,80,80),
    OFF     = Color3.fromRGB(55,40,40),
    WARN    = Color3.fromRGB(210,180,120),
...
-- GUI
-- ════════════════════════════════════════════════════════════
pcall(function() local o=CoreGui:FindFirstChild("ROLEX_v45_ultra"); if o then o:Destroy() end end)
local GUI = Instance.new("ScreenGui")
GUI.Name="ROLEX_v45_ultra"; GUI.ResetOnSpawn=false
...
Win.Name="ROLEX_Main"; Win.Size=UDim2.new(0,WW,0,WH)
...
WinBg.Image="rbxassetid://18287051021"; WinBg.ImageTransparency=0.9
...
local TitleLbl=MkLabel(Header,{text="ROLEX ENGINE",size=16,color=T.TEXT,font=Bold,sz=UDim2.new(0,140,0,22),pos=UDim2.new(0,56,0,12),z=14})
local VersionLbl=MkLabel(Header,{text="V6 - w love by rolex 🖤",size=8,color=T.ACCENT,font=Reg,sz=UDim2.new(0,200,0,12),pos=UDim2.new(0,56,0,34),z=14})
...
TBtn.Name="ROLEX_Toggle"; TBtn.Size=UDim2.fromOffset(52,52)
TBtn.BackgroundColor3=T.BG; TBtn.BackgroundTransparency=0.02
TBtn.Text="ROLEX"; TBtn.FontFace=Bold; TBtn.TextSize=18; TBtn.TextColor3=T.ACCENT
...
do
    ...
    MkLabel(ulCard,{text="UNLOAD ROLEX",size=8,color=T.DIM,font=Bold,sz=UDim2.new(1,-32,0,12),pos=UDim2.new(0,16,0,8),z=14})
    local ulBtn=MkBtn(ulCard,{bg=T.ERR,text="UNLOAD ROLEX",size=10,color=T.TEXT,sz=UDim2.new(1,-32,0,26),pos=UDim2.new(0,16,0,20),corner=7,bgt=0.1,z=15})
    local ulC=false
    ulBtn.MouseButton1Click:Connect(function()
        if not ulC then
            ulC=true; ulBtn.Text="CLICK AGAIN TO CONFIRM"
            task.delay(3,function() ulC=false; ulBtn.Text="UNLOAD ROLEX" end)
        else
...
do
    ...
    MkSlider(P,"ATTACKS PER SECOND",9000,90000,SAVE.kaAPS,8,function(v) kaAPS=v; kaCD=1/v; SAVE.kaAPS=v; task.delay(.5,DoSave) end)
    MkSlider(P,"RANGE",9,9000,SAVE.kaRange,9,function(v) kaRange=v; SAVE.kaRange=v; task.delay(.5,DoSave) end)
...
print("✓ rolex v6 starting...")

Win.Visib=true
GoTab(1)

print("✓ rolex v6 loaded!")
Notif("ROLEX V6","EZZZ ROLEX V6!","ok")