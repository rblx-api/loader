...
subLbl.Text               = "discord.gg/fenixhub"
...
brandSub.Text               = "discord.gg/fenixhub"
...
local function setupChar(char)
    ...
    if head then
        local old = head:FindFirstChild("FenixBB"); if old then old:Destroy() end
        local bb = Instance.new("BillboardGui", head)
        bb.Name="FenixBB"; bb.Size=UDim2.new(0,130,0,36)
...
RunService.RenderStepped:Connect(function()
    ...
    pcall(function()
        ...
        if hd then
            local bb = hd:FindFirstChild("FenixBB")
...
print("[FénixHub] Cargado - Letras con sombra chorreada aplicadas.")