...
task.spawn(function()
    ...
    local function showHighPingAlert()
        ...
        pcall(function()
            local old = CoreGui:FindFirstChild("ReyHubHighPingAlert")
            if old then old:Destroy() end
        end)
        pcall(function()
            local old = playerGui and playerGui:FindFirstChild("ReyHubHighPingAlert")
            if old then old:Destroy() end
        end)

        local gui = Instance.new("ScreenGui")
        gui.Name = "ReyHubHighPingAlert"
...
do
    ...
    if not noIntroSaved then
        ...
        introScreenGui.Name = "ReyHubIntro"
        ...
        introSound.Name = "ReyHubIntroSound"
        ...
        skipIntroButton.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
        ...
        skipStroke.Color = Color3.fromRGB(60, 60, 60)
        ...
        introImage.ImageColor3 = Color3.fromRGB(50, 50, 50)
        ...
        local introGlitchDark = makeIntroText("GlitchDark", Color3.fromRGB(30, 30, 30), 1, 1005)
        local introGlitchBright = makeIntroText("GlitchBright", Color3.fromRGB(100, 100, 100), 1, 1006)
        local introTitleGlow = makeIntroText("IntroTitleGlow", Color3.fromRGB(80, 80, 80), 1, 1007)
        introTitleGlow.TextSize = 64
        introTitleGlow.TextStrokeColor3 = Color3.fromRGB(80, 80, 80)
        ...
        introTitleGradient.Color = ColorSequence.new({
            ...
            ColorSequenceKeypoint.new(0.30, Color3.fromRGB(80, 80, 80)),
            ColorSequenceKeypoint.new(0.56, Color3.fromRGB(200, 200, 200)),
            ColorSequenceKeypoint.new(0.76, Color3.fromRGB(100, 100, 100)),
        ...
        introVsGlow.Text = ".vs"
        introVsGlow.TextColor3 = Color3.fromRGB(80, 80, 80)
        introVsGlow.TextSize = 58
        introVsGlow.TextTransparency = 1
        introVsGlow.TextStrokeColor3 = Color3.fromRGB(80, 80, 80)
        ...
        introVs.TextSize = 54
        introVs.TextStrokeColor3 = Color3.fromRGB(20, 20, 20)
        introVs.ZIndex = 1010
        introVs.Parent = introContent

        local introVsGhost = introVs:Clone()
        introVsGhost.Name = "IntroVsGhost"
        introVsGhost.TextColor3 = Color3.fromRGB(30, 30, 30)
        ...
        for i = 1, 12 do
            ...
            slice.BackgroundColor3 = i % 3 == 0 and Color3.fromRGB(80, 80, 80) or Color3.fromRGB(40, 40, 40)
        ...
        for i = 1, 22 do
            ...
            spark.BackgroundColor3 = Color3.fromRGB(200, 200, 200)
        ...
        task.spawn(function()
            ...
            introTitle.Text = "REY HUB"
            introTitleGlow.Text = "REY HUB"
            introGlitchBright.Text = "REY HUB"
            introGlitchDark.Text = "REY HUB"
            titleEntrance()
            glitchBurst(15, 0.30)
            ...
            if not ok then                warn("[REY HUB Intro] Animation error: " .. tostring(err))
            end
            finishIntro()
        end)
...
local function showDiscordInProgressBar()
	...
	task.delay(4, function()
		if progressPct then
			...
			progressPct.TextColor3 = originalColor or Color3.fromRGB(255, 255, 255)
...
local _C={
	...
	[3]=Color3.fromRGB(8, 8, 8),
	[4]=Color3.fromRGB(20, 20, 20),
	[5]=Color3.fromRGB(60, 60, 60),
	[6]=Color3.fromRGB(40, 40, 40),
	[7]=Color3.fromRGB(255, 255, 255),
	[8]=Color3.fromRGB(150, 150, 150),
	[9]=Color3.fromRGB(0, 0, 0),
	[10]=Color3.fromRGB(10, 10, 10),
}
...
premiumInnerStroke.Color = Color3.fromRGB(30, 30, 30)
...
State.applyBackgroundImage = function(assetId, shouldSave)
	...
	for id, visual in pairs(State.imageChoiceVisuals) do
		...
		if visual.badge then
			...
			visual.badge.BackgroundColor3 = selected and WHITE or Color3.fromRGB(0, 0, 0)
...
local function baseCard(tabName, h2)
	...
	bottomDetail.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
