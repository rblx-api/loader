...
local T = {
    ...
    CARD    = Color3.fromRGB(20, 5, 40),
    RAISED  = Color3.fromRGB(30, 10, 55),
    BORDER  = Color3.fromRGB(180, 80, 255),
    TEXT    = Color3.fromRGB(180, 80, 255),
    MUTED   = Color3.fromRGB(150, 120, 200),
    DIM     = Color3.fromRGB(70, 30, 100),
    ACCENT  = Color3.fromRGB(200, 100, 255),
    ON      = Color3.fromRGB(200, 100, 255),
    OFF     = Color3.fromRGB(50, 20, 70),
    WARN    = Color3.fromRGB(255, 220, 50),
    ERR     = Color3.fromRGB(255, 60, 60),
    MATRIX  = Color3.fromRGB(180, 80, 255),
    GLOW    = Color3.fromRGB(180, 80, 255),
    SCAN    = Color3.fromRGB(140, 60, 200),
}
...
SAVE.phrases      = SAVE.phrases      or "ETM ON TOP!"
...
-- GUI
-- ════════════════════════════════════════════════════════════
pcall(function() local o=CoreGui:FindFirstChild("ETM_v45_ultra"); if o then o:Destroy() end end)
local GUI = Instance.new("ScreenGui")
GUI.Name="ETM_v45_ultra"; GUI.ResetOnSpawn=false
...
Win.Name="ETM_Main"; Win.Size=UDim2.new(0,WW,0,WH)
...
WinBg.Image="rbxassetid://6675147490"; WinBg.ImageTransparency=0.9
...
MkLabel(logo, {text="ETM", size=11, color=T.ACCENT, font=Bold, sz=UDim2.new(1,0,1,0), xa=Enum.TextXAlignment.Center, z=14})

local TitleLbl=MkLabel(Header,{text="ETM ENGINE",size=16,color=T.TEXT,font=Bold,sz=UDim2.new(0,140,0,22),pos=UDim2.new(0,56,0,12),z=14})
local VersionLbl=MkLabel(Header,{text="V5 - w love by rolex 🖤",size=8,color=T.ACCENT,font=Reg,sz=UDim2.new(0,200,0,12),pos=UDim2.new(0,56,0,34),z=14})
...
TBtn.Name="ETM_Toggle"; TBtn.Size=UDim2.fromOffset(52,52)
TBtn.BackgroundColor3=T.BG; TBtn.BackgroundTransparency=0.02
TBtn.Text="ETM"; TBtn.FontFace=Bold; TBtn.TextSize=18; TBtn.TextColor3=T.ACCENT
...
do
    ...
    ulBtn.MouseButton1Click:Connect(function()
        if not ulC then
            ...
            task.delay(3,function() ulC=false; ulBtn.Text="UNLOAD ETM" end)
        else
...
print("✓ etm v5 starting...")

Win.Visible=true
GoTab(1)

print("✓ etm v5 loaded!")
Notif("ETM V5","Your arsenal has loaded!","ok")