...
local CLR = {
    ...
    TabPanel     = Color3.fromRGB(18,  18,  20),
    TabBtn       = Color3.fromRGB(40,  40,  45),
    TabBtnActive = Color3.fromRGB(200,  30,  30),
    OptionRow    = Color3.fromRGB(28,  28,  32),
    OptionStroke = Color3.fromRGB(60,  60,  65),
    Bind         = Color3.fromRGB(45,  45,  50),
    ToggleOff    = Color3.fromRGB(35,  35,  40),
    ToggleOn     = Color3.fromRGB(200,  30,  30),
    KnobOff      = Color3.fromRGB(140, 140, 145),
...
local function createMobilePanel()
    ...
    local function makeMobileBtn(name, text, defaultPos, saveKey, callback, isToggle)
        ...
        stroke(container, Color3.fromRGB(200, 30, 30), 1)
        ...
        local function setActive(state)
            active = state
            if active then
                container.BackgroundColor3 = Color3.fromRGB(200, 30, 30)
                btn.TextColor3 = Color3.fromRGB(255, 255, 255)
            else
                container.BackgroundColor3 = Color3.fromRGB(25, 25, 28)
                btn.TextColor3 = Color3.fromRGB(255, 255, 255)
        ...
        btn.MouseButton1Down:Connect(function()
            if not isToggle then container.BackgroundColor3 = Color3.fromRGB(200, 30, 30); btn.TextColor3 = Color3.fromRGB(255, 255, 255) end
        end)
        btn.MouseButton1Up:Connect(function()
            if not isToggle then container.BackgroundColor3 = Color3.fromRGB(25, 25, 28); btn.TextColor3 = Color3.fromRGB(255, 255, 255) end
        end)
...
TextoGoteo.TextColor3 = Color3.fromRGB(40, 10, 10)
...
TextoFondo.TextColor3 = Color3.fromRGB(200, 30, 30)
...
TextoBrillo.TextColor3 = Color3.fromRGB(255, 80, 80)
...
titleShadow.TextColor3         = Color3.fromRGB(40, 10, 10)
...
titleLbl.TextColor3         = Color3.fromRGB(200, 30, 30)
...
brandShadow.TextColor3         = Color3.fromRGB(40, 10, 10)
...
brandTitle.TextColor3         = Color3.fromRGB(200, 30, 30)
...
brandLine.BackgroundColor3 = CLR.Red
...
local function setupChar(char)
    ...
    if head then
        ...
        sl.TextColor3=Color3.fromRGB(200, 30, 30)
...
print("[ReyHub] Cargado - Tema rojo y gris aplicado.")