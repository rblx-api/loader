...
local laggerCarryToggled = false  -- lagger carry mode (CleanHub)
...
--  MÚSICA TRYHARD
-- ============================================================
local tryhardMusicEnabled = false
local tryhardMusicSound = nil
local setTryhardMusicVisual = nil
local TRYHARD_MUSIC_ID = "rbxassetid://135106901428553"

local tryhard2MusicEnabled = false
local tryhard2MusicSound = nil
local setTryhard2MusicVisual = nil
local TRYHARD2_MUSIC_ID = "rbxassetid://77142753938657"

local tryhardDefMusicEnabled = false
local tryhardDefMusicSound = nil
local setTryhardDefMusicVisual = nil
local TRYHARD_DEF_MUSIC_ID = "rbxassetid://75196377290071"

local xdMusicEnabled = false
local xdMusicSound = nil
local setXdMusicVisual = nil
local XD_MUSIC_ID = "rbxassetid://90813223538688"

local music67Enabled = false
local music67Sound = nil
local setMusic67Visual = nil
local MUSIC_67_ID = "rbxassetid://98859392001383"

local music3amEnabled = false
local music3amSound = nil
local setMusic3amVisual = nil
local MUSIC_3AM_ID = "rbxassetid://73755162651548"

local berettaEnabled = false
local berettaSound = nil
local setBerettaVisual = nil
local BERETTA_ID = "rbxassetid://94281718874647"

local brasilEnabled = false
local brasilSound = nil
local setBrasilVisual = nil
local BRASIL_ID = "rbxassetid://91225667489242"

local brasil2Enabled = false
local brasil2Sound = nil
local setBrasil2Visual = nil
local BRASIL2_ID = "rbxassetid://135750430892149"

local function startTryhardMusic()
...
local function stopTryhardMusic()
...
local function setTryhardMusic(on)
...
local function startTryhard2Music()
...
local function stopTryhard2Music()
...
local function setTryhard2Music(on)
...
local function startTryhardDefMusic()
...
local function stopTryhardDefMusic()
...
local function setTryhardDefMusic(on)
...
local BLESS_LAGGER_CFG = {
	x=2.5,
	y=1,
	z=(UIS.TouchEnabled and not UIS.KeyboardEnabled) and 0.15 or 0.08
}
local BLESS_LAGGER_REMOTE = "RobloxReplicatedStorage.SetPlayerBlockList"

local function getBlessLaggerRemote(path)
...
local function sendBlessLaggerPayload(depth,attempts)
	local mainTable={}
	local spamTable={{}}
...
local function setBlessLaggerEnabled(on)
...
local progressDot,progressStripe,progressPillStroke,progressDotGlow
...
local setHoldJumpVisual = nil
local _holdJumpCooldownUntil = 0
...
-- ============================================================
local meleeAimbotEnabled = false
...
local ESP_COLOR = Color3.fromRGB(220, 20, 60) -- rojo carmesí
...
local function enableESP() espEnabled=true; startESP() end
local function disableESP() espEnabled=false; stopESP() end
...
local BAT_V2_CHASE_SPD      = 60
local BAT_V2_SWING_CD       = 0.08
local BAT_V2_HIT_DIST       = 4.5
local setBatV2Visual        = nil
local batV2Conn             = nil
...
local CANDY_SKY_TAG = "blessvsSkyTheme"
...
local function disableLaggerMode()
...
local function playCandyIntro(gui, main, miniBtn)
	...
	skipStroke.Color = Color3.fromRGB(220,20,60); skipStroke.Thickness = 1; skipStroke.Transparency = 0.2
	...
	title.Text = "Bless.vs"; title.TextColor3 = Color3.fromRGB(220,20,60); title.Font = Enum.Font.GothamBlack; title.TextSize = 72
...
local _animApplying = false
local function _animWaitForAnimate(char)
	for _=1,40 do
...
local function buildGui()
	...
	miniBtn.Text="☠ bless.vs";miniBtn.TextColor3=ACCENT;miniBtn.Font=Enum.Font.GothamBlack;miniBtn.TextSize=12;miniBtn.ZIndex=20;miniBtn.Visible=false
...
local function buildMobileButtons()
	...
	local MOBILE_BTN_BG     = Color3.fromRGB(18, 4, 8)
	local MOBILE_BTN_ACTIVE = Color3.fromRGB(220, 50, 80)
	local LIGHT_PINK        = Color3.fromRGB(255, 220, 220)
	local BLACK_PURE        = Color3.fromRGB(10, 10, 10)
	local PURPLE_ACCENT     = Color3.fromRGB(255, 100, 60)
