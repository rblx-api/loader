...
Keybinds = {
    ...
    ["Ragdoll Self"]="R",["Drop Brainrot"]="G",Float="Z",["Auto Buy"]="K",
    ["Click to AP"]="NONE",
    ["Steal Nearest"]="NONE",
    ["Face Nearest"]="NONE"
}
...
task.spawn(function()
    while true do
        task.wait(0.05)
        if Config.AutoDestroyTurrets and not _autoDestroyBusy and LocalPlayer:GetAttribute("Stealing") ~= true then
            local char = LocalPlayer.Character
            local hrp = char and char:FindFirstChild("HumanoidRootPart")
            local hum = char and char:FindFirstChildOfClass("Humanoid")
            if hrp and hum then
