...
local STROKE_ACTIVE = Color3.fromRGB(255, 140, 0)
...
miniFrame.BackgroundColor3 = Color3.fromRGB(255, 140, 0)
...
local hubTitleLbl = New("TextLabel", {
    Text = "STICK DUELS", TextColor3 = Color3.fromRGB(255, 255, 255),
