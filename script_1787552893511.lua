...
local function executeSteal(prompt)
    ...
    Conns.progress = RunService.Heartbeat:Connect(function()
        ...
        if progressPct then progressPct.Text = "CTZ_DUELS | " .. math.floor(prog * 100) .. "%" end
    end)
...
loadAllSettings = function()
    ...
    local function resetProgressBar()
        if progressPct then progressPct.Text = "CTZ_DUELS" end
...
-- FPS centrados, separados del nombre CTZ_DUELS.
