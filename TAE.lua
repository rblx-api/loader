...
local COLORS = {
    Window = Color3.fromRGB(5, 25, 70),
    Row = Color3.fromRGB(8, 40, 100),
    Control = Color3.fromRGB(12, 55, 135),
    Log = Color3.fromRGB(4, 22, 60),
    Border = Color3.fromRGB(35, 120, 255),
    White = Color3.fromRGB(235, 245, 255),
    Text = Color3.fromRGB(190, 220, 255),
    Dim = Color3.fromRGB(120, 175, 235),
    Accent = Color3.fromRGB(30, 115, 255),
    Green = Color3.fromRGB(70, 210, 255),
...
BackgroundImage.BackgroundColor3 = COLORS.Window
...
makeLabel(Header, "Title", "TAE CODE SNIPER", UDim2.fromOffset(180, 25), UDim2.fromOffset(56, 17), 15, COLORS.White, Enum.Font.GothamBold)
...
local DiscordFooter = makeLabel(Window, "DiscordFooter", "discord.gg/MXAXDAuZP", UDim2.fromOffset(140, 19), UDim2.new(0.5, -70, 0, 346), 10, COLORS.White, Enum.Font.GothamBold)
