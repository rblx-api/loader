...
-- Color Theme is permanently fixed to Azul (Blue).
local COLOR_THEMES = {
    ["Azul"] = Color3.fromRGB(37, 99, 235),
}

currentColorTheme = "Azul"
selectedColor = COLOR_THEMES["Azul"]
...
function applyColorTheme(themeName)
    -- Theme is permanently fixed to Azul.
    local color = COLOR_THEMES["Azul"]
    currentColorTheme = "Azul"
    selectedColor = color
...
function paintFloatingBtn(btnFrame, active)
    ...
    -- are completely removed from the visual stack so the ENTIRE box is blue.
    btnFrame.BackgroundTransparency = 0
    btnFrame.BackgroundColor3 = active and BLUE or Color3.fromRGB(255,255,255)
...
local FLOATING_BLUE = Color3.fromRGB(37, 99, 235)
...
function buildGui()
    ...
    -- Color Theme toggle removed. Theme is permanently fixed to Azul.
    ...
    local blueFill = Color3.fromRGB(37, 99, 235)
    local blueGlow = Color3.fromRGB(96, 165, 250)
    fillGrad.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0.00, blueFill),
        ColorSequenceKeypoint.new(0.50, blueGlow),
        ColorSequenceKeypoint.new(1.00, blueFill),
    })
    fillGrad.Rotation = 0
    ...
    -- the more the bar fills. The fill is always blue.
    task.spawn(function()
