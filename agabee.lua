...
local authorizedUsers = {"wrt_0319", "Egecik148"}
...
-- Jumpscare Scripti (Miranda Hub Yüklenmeden Önce Çalışır)
...
-- 3. Ekran Sallantı ve Flaş Efekti
task.spawn(function()
    for i = 1, 15 do
...
-- 4. 2 Saniye Sonra Jumpscare'i Kaldır ve Asıl Scripti (Miranda Hub) Çalıştır
task.delay(2, function()
    -- Jumpscare temizleme
    scareSound:Destroy()
    screenGui:Destroy()
    
    -- Miranda Hub Yükleyici
