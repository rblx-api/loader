...
-- Background image (nuevo fondo: 96529714818350)
local bgImage = create("ImageLabel", {
Name = "Background",
BackgroundTransparency = 1,
Image = "rbxassetid://96529714818350",
...
-- Titulo eliminado del header, se creara en el main
...
corner(keybindButton, 5)

-- Titulo "Rinval anti anti decyn" en color negro, ESQUINA SUPERIOR IZQUIERDA
local title = create("TextLabel", {
Name = "Title",
BackgroundTransparency = 1,
Text = "Rinval anti anti decyn",
...
-- Credito "by Rinval" abajo a la derecha
...
local knobPosition = value and UDim2.new(1, -13, 0, 3)
...
Size = UDim2.new(0, 300, 0, runtime.isMinimized and MINI_HEIGHT or FULL_HEIGHT)
}):Play()
end)
