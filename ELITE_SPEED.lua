print("full deobf by 073 / nuchim deobf / dexter")
print("https://discord.gg/yhZ9gszPC - https://discord.gg/4TcrmuX6J")
print("full deobf by 073 / nuchim deobf / dexter")
print("https://discord.gg/yhZ9gszPC - https://discord.gg/4TcrmuX6J")
print("full deobf by 073 / nuchim deobf / dexter")
print("https://discord.gg/yhZ9gszPC - https://discord.gg/4TcrmuX6J")
...
-- ============ CONFIG SAVE/LOAD ============
local CONFIG_FILE = "CursedSkidBypass.json"
...
-- 10 Window sizes (smallest to largest) - scales ENTIRE GUI
local WINDOW_SIZES = {
...
-- ============ BACKGROUND METHOD (1 foto, ON/OFF) ============
local BG_URL = "https://kastor-box.lovable.app/api/public/f/7c6xd9bf.png"
local BG_FILE = "CursedHubBG.png"
local BG_ASSET = nil
...
local function cleanupGUI()
    local existing = Players.LocalPlayer and Players.LocalPlayer.PlayerGui:FindFirstChild("CursedHubSpeedBypass")
    if existing then
        existing:Destroy()
    end
    if running then
...
-- Update UI colors based on enabled state
...
local function buildUI()
    ...
    screenGui.Name = "CursedHubSpeedBypass"
    ...
    titleText.Text = "CURSED HUB SPEED BYPASS"
