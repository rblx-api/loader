...
local _M
do _M=function()
local _1_l_i1illI1={"\x5B\xE8\x0A\x04"}
local _illIII11_l2={0x2,0x9C,0x4B,0x56,0x75,0x68,0xEE,0xDE,0xAB}
local _I11_l_i1il3={0x1}
local _1_l_i1illI2s={0x11}
local _i1illIII114={0x1,0x1,0x2,0x3}
